  ...
  return (
    <div className="relative w-full py-24 md:py-32 bg-dark overflow-hidden flex items-center">
      {bgImgUrl ? (
        ...
        <div className="absolute inset-0 bg-[url('/gallery-hero-bg.jpg')] bg-cover bg-center opacity-40 mix-blend-overlay" />
      )}
      ...
      <Container className="relative z-10">
        <div className="max-w-2xl">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="font-bold text-xs md:text-sm uppercase tracking-widest text-primary">{subtitle}</span>
          </div>
