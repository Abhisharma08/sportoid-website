...
export function AuthorCard() {
  return (
    <div className="bg-white border border-gray-100 rounded-lg p-8 text-center mb-12">
      <h4 className="font-heading font-semibold uppercase tracking-wider mb-6 pb-2 border-b-2 border-primary inline-block">
        About The Author
      </h4>
      <div className="w-24 h-24 mx-auto rounded-full bg-dark flex items-center justify-center text-primary text-4xl font-semibold mb-4">
        S
      </div>
      <h5 className="font-heading font-semibold text-lg mb-2">Sportoid Team</h5>
