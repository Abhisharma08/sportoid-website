      ...
      <Container className="relative z-10">
        <div className="max-w-2xl">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="font-semibold text-xs md:text-sm uppercase tracking-widest text-primary">{heroBreadcrumbs}</span>
          </div>
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-heading font-semibold text-white leading-tight mb-6 whitespace-pre-line">
